...
Nous utiliserons les extensions dites «~SSE~» (SSE, SSE2,SSE3, SSSE3, SSE4.1 et SSE4.2), sachant qu'il en existe de plus modernes (AVX, AVX2, AVX512) et de plus anciennes (MMX), ...
...
Idem pour l'AVX, en remplacant 128 par 256, et en ajustant les facteurs multiplicatifs.
...
En pratique, j'ai utilisé, pour l'implantation que j'ai réalisée en SSE, uniquement les types \lstinline{__m128} et \lstinline{__m128i} et les 9 fonctions intrinsèques suivantes~: \\
